...
```{r}
train_image_files_path = "C:/Users/Michael Thomsen/Desktop/fruits-360_dataset/fruits-360/Training/"

test_image_files_path = "C:/Users/Michael Thomsen/Desktop/fruits-360_dataset/fruits-360/Test/"
```
...
#Testing images
valid_image_array_gen = flow_images_from_directory(test_image_files_path,
                                          valid_data_gen,
                                          class_mode = "categorical", 
                                          classes = fruit_list,
                                          seed = 123)
...
model %>% 
  layer_conv_2d(filters = 32, kernel_size = c(3,3),padding = "same", input_shape = c(img_width, img_height, channels)) %>% 
...
hist <- fit_generator(
  ...
  callbacks = list(
    ...
    callback_tensorboard(log_dir = file.path(path, "fruit_logs"))
  )
)
