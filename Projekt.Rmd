...
valid_image_files_path = "C:/Users/Michael Thomsen/Desktop/fruits-360_dataset/fruits-360/Test/"
```
...
#RBG Channels is set to 3, due to RBG images has three channels (Red,Green and Blue)
channels <- 3
...
#Testing images
vaild_image_array_gen <- flow_images_from_directory(valid_image_files_path,
                                          valid_data_gen,
                                          class_mode = 'categorical', 
                                          classes = fruit_list,
                                          seed = 42)
