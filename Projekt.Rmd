...
```{r}
FV_list <- c("Quince","Tangelo","Walnut","Physalis","Pepino","Orange","Blueberry","Mulberry","Kaki",
                "Guava","Eggplant","Carambula","Beetroot","Apricot","Avocado")

output_n <- length(FV_list)

img_width <- 20
img_height <- 20
target_size <- c(img_width, img_height)
#RBG Channels is set to three, due to RBG images has three 'channels' (Red, Green and Blue)
channels <- 3
```
...
test_samples <- test_image_array$n
