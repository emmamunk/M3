...
```{r}
resnet50 = keras::application_resnet50(include_top = FALSE, weights = NULL, pooling = 'avg', input_shape = c(64, 64 ,3))
```
...
```{r}
model1 = model %>% layer_flatten() %>% layer_dense(units = 128, activation = "relu")
model1 = model1 %>% layer_dense(units = 16, activation = "softmax")
```
